  ...
  return (
    <div className="no-scrollbar h-full w-full overflow-y-scroll">
      ...
      <div className="wrap flex flex-col items-center justify-center gap-2 pt-20">
        <h1 className=" mt-14 pb-5 text-[32px] font-[600]">Welcome back</h1>

        <EmailInput
          showThirdPartyComponent={handleShowThirdPartyComponent}
          isLogin={true}
        />

        <div className=" mt-3 text-sm text-text-dark">
          Don&apos;t have an account?
          <a href="/auth/signup" className="mx-1.5 text-green">
            Sign up
          </a>
        </div>
        {thirdParty ? (
      ...
      <div className="m mb-10 mt-40 flex flex-row items-center justify-center gap-1 text-[14px] text-green">
        <Link href="https://openai.com/policies/terms-of-use" target="__blank">
          Terms of use
        </Link>
        <span>|</span>
        <Link href="https://openai.com/policies/terms-of-use" target="__blank">
