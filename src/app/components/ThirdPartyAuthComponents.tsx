...
const ThirdPartyAuthComponents: React.FC<ThirdPartyAuthComponentsProps> = () => {
   const [signInWithGoogle, user, loading, error] =
    ...
    return <>
        <div>
            <button onClick={handleSignInWithGoogle} className='rounded text-text-dark outline-1 outline-gray-mid outline w-80 p-3.5 mt-3.5 hover:bg-opacity-100 duration-300 hover:bg-gray-light'>
